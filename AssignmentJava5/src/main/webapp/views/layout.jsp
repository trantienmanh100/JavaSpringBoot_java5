						...
						<div class="col-lg-7 col-md-12 col-12">
							...
							<div class="right-content">
								<ul class="list-main">
									...
									<li><i class="ti-alarm-clock"></i> <a href="/sale/purchase">Đơn hàng</a></li>
							...
							<div class="search-bar-top">
								<div class="search-bar">
									...
									<form action="search" method="get">
										<input name="name" placeholder="Search Hairs Here....." type="search" >
						...
						<div class="col-lg-2 col-md-3 col-12">
							<div class="right-bar">
								...
								<div class="sinlge-bar shopping">
									<a href="/cart/index" class="single-icon"><i class="ti-bag"></i> <span class="total-count">${listCart.size() }</span></a>
									<!-- Shopping Item -->
										...
										<div class="navbar-collapse">	
											<div class="nav-inner">	
												<ul class="nav main-menu menu navbar-nav">
													<li class="active"><a href="/hair/sale">Trang chủ</a></li>
